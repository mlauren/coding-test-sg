...
Thanks for the opportunity to code with you guys and learn some new things :) I ran into some time limits so I ended up only comleting the comments slider and using prebuilt libraries for the carousel and side menu instead. I think these worked out fine but given more time, I would have liked to build a fully functional carousel (rather than the one attached to the project.
...
```
## TODOs
- Update Extract Text Plugin to mini-css-extract-plugin
- Webpack compile css and JS
- SASSy exports for font styles
- Iron out bugs for carousel and Comments plugins and add CSS animations- ran out of time
